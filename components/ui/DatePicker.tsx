...
export function DatePicker({
  ...
  const dropdown = isOpen ? (
    <>
      ...
      {/* Calendar */}
      <div
        className="fixed z-50 bg-white rounded-xl shadow-xl border border-stone-200 p-4"
        style={{
          top: `${position.top}px`,
      ...
      >
            <DayPicker
              ...
              classNames={{
                ...
                weekdays: 'flex',
                weekday: 'text-stone-500 rounded-md w-9 font-normal text-xs',
                ...
                day_button: 'inline-flex items-center justify-center rounded-lg w-9 h-9 hover:bg-pink-50 hover:text-pink-600 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-300',
                selected: 'bg-pink-500 text-white hover:bg-pink-600 hover:text-white focus:bg-pink-500 focus:text-white',
                today: 'bg-stone-100 text-stone-900 font-semibold',
                outside: 'text-stone-300 opacity-50',
                disabled: 'text-stone-300 opacity-50 cursor-not-allowed hover:bg-transparent',
